...
-- - Weekly IMAGE is currently interpreted at the app level as 0 or 1 row per class_log.
...
-- 4. Schema changes should be reflected in SPEC/PLAN/PROGRESS as needed.
