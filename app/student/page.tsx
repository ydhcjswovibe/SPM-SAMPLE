...
export default function StudentDashboardPage() {
    ...
    if (error) {
        const needsLogin =
            ...
            error.message === studentAuthRequiredMessage;
                    ...
                    <CardContent className="flex flex-col items-start gap-3 p-4 text-sm text-[#b65046]">
                        <div className="flex items-start gap-3">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-[rgba(182,80,70,0.8)]">
                                    {getFriendlyStudentMessage(error)}
                                </p>
                            </div>
                        </div>
                        {needsLogin ? (
                ...
                <section className="relative overflow-hidden rounded-2xl border border-[#dfe8d2] bg-card px-4 pb-5 pt-4 shadow-[0_16px_30px_rgba(111,145,72,0.1)]">
                    ...
                    <div className="relative z-10 flex flex-col items-center text-center">
                        ...
                        <p className="mt-2 max-w-sm text-sm leading-6 text-[#49613a]">
                            원하는 수업과 월을 골라 두면 운영 쪽에서 확인하고
                            바로 등록 예정 상태로 올려 둘 수 있어요.
                        </p>
                    </div>
                </section>
            ...
            <div className="px-3 pb-28 pt-3">
                <Card className="overflow-hidden rounded-2xl border border-[#e3ead7] bg-white py-0 shadow-[0_16px_28px_rgba(111,145,72,0.08)]">
                    <CardContent className="space-y-2 px-4 py-5 text-sm text-[#68785c]">
                        <p className="font-semibold text-[#314127]">
                            대표 수업을 찾지 못했습니다.
                        </p>
                        <p>
                            잠시 후 다시 불러오거나, 수업 탭에서 직접 선택해
                            주세요.
                        </p>
                        <Button
                            onClick={() => router.push(lessonsHref)}
    ...
    const summaryCards = [
        {
            ...
            iconClass:
                "border-[#f3e4b3] bg-white text-[#bc8b20] shadow-[0_8px_14px_rgba(218,180,76,0.16)]",
            iconGraphicClass: "translate-y-px",
            labelClass: "text-[#8d6f26]",
            done:
                selectedSummary.attendanceTotal > 0 &&
                selectedSummary.attendanceChecked >=
                    selectedSummary.attendanceTotal,
        },
        {
            key: "content",
            icon: Sparkles,
            ...
            iconClass:
                "border-[#dbe5f8] bg-white text-[#5a7ecb] shadow-[0_8px_14px_rgba(128,164,220,0.14)]",
        ...
        },
        {
            ...
            iconClass:
                "border-[#eadfdc] bg-white text-[#cb718a] shadow-[0_8px_14px_rgba(214,128,157,0.14)]",
            iconGraphicClass: "translate-y-px",
    ...
    return (
        <div className="space-y-3 px-3 pb-28 pt-3">
            <section
                ...
                className="relative overflow-visible rounded-2xl border border-[#dfe8d1] bg-card px-3.5 pb-3.5 pt-3.5 shadow-[0_16px_30px_rgba(111,145,72,0.1)]"
            >
                <div className="absolute inset-x-0 bottom-0 h-20 bg-[rgba(172,207,116,0.26)]" />
                <div
                    className="absolute -left-6 bottom-2 h-12 rounded-full bg-[rgba(146,193,98,0.18)]"
                    style={{ width: "4.5rem" }}
                />
                <div className="absolute left-1/2 bottom-0 h-20 w-32 -translate-x-1/2 rounded-full bg-[rgba(129,179,83,0.12)]" />
                <div
                    className="absolute right-0 bottom-4 h-12 rounded-full bg-[rgba(194,222,144,0.16)]"
                    style={{ width: "4.5rem" }}
                />

                <div className="absolute left-4 top-3.5 z-20 inline-flex items-center gap-1.5 rounded-full border border-[#d8bf69] bg-accent px-1.5 py-1 text-[#6e5512] shadow-[inset_0_1px_0_rgba(255,255,255,0.92),inset_0_-1px_0_rgba(191,157,62,0.18)]">
                    ...
                    <span className="pr-1 text-[11px] font-black tracking-[-0.03em]">
                        Lv.{progressPreview.level}
                    </span>
                </div>

                <div
                    className="relative z-10 flex flex-col justify-end gap-2 pt-4"
                    style={{ minHeight: "10.2rem" }}
                >
                    ...
                    <div
                        ...
                        className="mx-0.5 rounded-2xl border border-[#dcc36f] bg-accent px-4 py-2.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.82),0_10px_16px_rgba(176,151,80,0.08)]"
                    >
                        <div className="space-y-2">
                            <div className="flex items-center justify-between gap-3">
                                ...
                                <p className="shrink-0 text-[11px] font-bold tracking-[-0.02em] text-[#5b4915]">
                                    <span className="font-black text-[#3e310d]">
                                        {progressPreview.xpCurrent}
                                    </span>
                                    /{progressPreview.xpTarget} XP
                                </p>
                            </div>
                            ...
                            <div className="relative z-10 flex min-w-0 flex-1 items-start justify-between gap-3">
                                ...
                                <div className="flex w-20 shrink-0 flex-col items-end text-right">
                                    ...
                                    <div className="flex items-end justify-end gap-1 text-[#26371d]">
                                        <p className="text-[1.8rem] font-black leading-none tracking-[-0.06em]">
                                            {item.valueMain}
                                        </p>
                                        {item.valueUnit ? (
                                            <p className="pb-0.5 text-[0.95rem] font-bold leading-none text-[#516642]">
                                                {item.valueUnit}
                                            </p>
                                        ) : null}
                                    </div>
