...
export default function StudentLessonsPage() {
  ...
  if (!summaries || summaries.length === 0) {
    return (
      <div className="space-y-4 px-3 pb-28 pt-3">
        <Card className="overflow-hidden rounded-2xl border border-[#e4ead8] bg-card py-0 shadow-[0_14px_28px_rgba(111,145,72,0.08)]">
          <CardContent className="space-y-4 px-4 py-6 text-center">
            <div className="flex flex-col items-center gap-3">
              <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-muted text-[#6b9444]">
            ...
            <Button
              ...
              className="mx-auto h-12 min-w-[12rem] gap-2 rounded-2xl bg-primary px-5 font-bold text-white"
            >
  ...
  if (!selectedSummary) {
    return (
      <div className="px-3 pb-28 pt-3">
        <Card className="overflow-hidden rounded-2xl border border-[#e3ead7] bg-card py-0 shadow-[0_16px_28px_rgba(111,145,72,0.08)]">
  ...
  return (
    <div className="space-y-3 px-3 pb-28 pt-3">
      <section className="grid grid-cols-3 gap-2 text-center">
        <div className="rounded-2xl border border-[#e4ead8] bg-white px-2 py-2.5 shadow-[0_10px_20px_rgba(111,145,72,0.06)]">
      ...
      <section className="rounded-2xl border border-[#e6ecda] bg-card p-3 shadow-[0_12px_22px_rgba(111,145,72,0.08)]">
        <div className="mb-3 px-1">
          <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[#7f9069]">콘텐츠</p>
        </div>

        {isDetailLoading ? (
          <Card className="overflow-hidden rounded-2xl border border-[#e1ead5] bg-white py-0 shadow-[0_12px_24px_rgba(111,145,72,0.08)]">
          ...
          <Card className="overflow-hidden rounded-2xl border border-destructive/30 bg-card py-0 shadow-[0_18px_36px_rgba(184,86,70,0.08)]">
            <CardContent className="flex flex-col items-start gap-3 p-4 text-sm text-[#b65046]">
              <div className="flex items-start gap-3">
                <AlertCircle className="mt-0.5 h-5 w-5 shrink-0" />
                <div className="space-y-1">
