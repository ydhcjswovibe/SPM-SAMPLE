...
export function AdminShellHeader({
  ...
  return (
    <header className={cn('sticky top-0 z-40 px-3 pt-3 md:px-6 md:pt-5 lg:px-7 lg:pt-6', className)}>
        ...
        <div className={adminToolbarSurfaceClass}>
          <div className="flex items-center justify-between gap-4">
            <div className="min-w-0 flex items-center gap-3">
              {controls ? (
                <div className={cn('flex min-w-0 items-center gap-2.5', controlsClassName)}>
                  {controls}
                </div>
              ) : null}
            </div>
